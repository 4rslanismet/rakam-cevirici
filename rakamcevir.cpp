...
int main() {
  ...
  cout<<"Yazı ile ifade etmek istediginiz uc basamakli sayiyi giriniz:\n";
  al:
  cin>>sayi;


  bas3=sayi%10;//birler bsamapı hesaplanıyor
  bas2=(sayi/10)%10 ;//onlar basamağı hesaplanıyor
  bas1=(sayi/100);//yüzler basamağı hesaplanıyor
  ...
  //basamak degerine gore string atamasi yap
      if(bas1==1){yuz="yüz";}
          ...
          else{cout<<"lütfen üç basamaklı bir sayi giriniz!!\n";
          goto al;
                  return 0 ;}
...
cout<<"girdiginiz sayi:"<<yuz<<" "<<on<<" "<<bir;
}
